 ...
 */
final class Version20221018131140 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `admin` ADD company_name VARCHAR(255) DEFAULT NULL, ADD company_adresse VARCHAR(255) DEFAULT NULL, ADD company_city VARCHAR(255) DEFAULT NULL, ADD company_zipcode VARCHAR(255) DEFAULT NULL, ADD company_country VARCHAR(255) DEFAULT NULL, ADD company_email VARCHAR(255) DEFAULT NULL, ADD company_phone VARCHAR(255) DEFAULT NULL, ADD company_tel VARCHAR(255) DEFAULT NULL, ADD day_from VARCHAR(255) NOT NULL, ADD day_to VARCHAR(255) NOT NULL, ADD hour_from VARCHAR(255) NOT NULL, ADD hour_to VARCHAR(255) NOT NULL, ADD day_closed VARCHAR(255) NOT NULL, ADD hour_closed VARCHAR(255) NOT NULL, ADD image VARCHAR(255) DEFAULT NULL');
